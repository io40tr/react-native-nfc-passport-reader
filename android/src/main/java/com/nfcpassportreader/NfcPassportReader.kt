...
class NfcPassportReader(context: Context) {
  ...
  private val availableFilesMap = mapOf(
    "EF_CARD_ACCESS" to PassportService.EF_CARD_ACCESS, 
    "EF_COM" to PassportService.EF_COM, 
    "EF_SOD" to PassportService.EF_SOD,
    "EF_DG1" to PassportService.EF_DG1, 
    "EF_DG2" to PassportService.EF_DG2, 
    "EF_DG3" to PassportService.EF_DG3, 
    "EF_DG4" to PassportService.EF_DG4,
    "EF_DG5" to PassportService.EF_DG5, 
    "EF_DG6" to PassportService.EF_DG6, 
    "EF_DG7" to PassportService.EF_DG7, 
    "EF_DG8" to PassportService.EF_DG8,
    "EF_DG9" to PassportService.EF_DG9, 
    "EF_DG10" to PassportService.EF_DG10, 
    "EF_DG11" to PassportService.EF_DG11, 
    "EF_DG12" to PassportService.EF_DG12,
    "EF_DG13" to PassportService.EF_DG13, 
    "EF_DG14" to PassportService.EF_DG14, 
    "EF_DG15" to PassportService.EF_DG15, 
    "EF_DG16" to PassportService.EF_DG16
  )
